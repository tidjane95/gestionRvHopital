		...
		<table class="enregistrement">
			...
			<tr class="valeur">
				...
				foreach ($tableaus as $valu ) {
                    echo "<td>".$valu['Id_Patient']."</td>";
                    echo "<td>".$valu['Prenom_Patient']."</td>";
                    echo "<td>".$valu['Nom_Patient']."</td>";
                    echo "<td>".$valu['Telephone_Medecin']."</td>";
                    echo "<td>".$valu['Age']."</td>";
                    echo "<td>".$valu['Sexe']."</td>";
                    echo "<td>".$valu['Adresse']."</td>";
				
				?>
				<td>
                <a href="modifierPatient.php?Id_Medecin=<?=$tableau['Id_Medecin']?>">Modifier</a>
                <a href="modifierPatient.php.php?Id_Medecin=<?=$tableau['Id_Medecin']?>">Supprimer</a>
