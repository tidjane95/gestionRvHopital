<?php
		...
		if(isset($_POST['valider'])){
			...
			echo "Tous les champs doivent etre remplie";
				...
				$email = $_POST['login'];
    			$passwd = $_POST['mpd'];
    			$req = $bdd->query("SELECT * FROM medecin WHERE utilisateur= '$email'  AND  motdepasse = '$passwd'   ");
...
<head>
    ...
    <link rel="stylesheet" href="logSecreteriat.css">
...
<style>
			...
			input[type=submit] {
				background-color: rgba(50, 235, 4, 0.8);
				color: white;
				padding: 14px 20px;
				margin: 8px 0;
				border: none;
